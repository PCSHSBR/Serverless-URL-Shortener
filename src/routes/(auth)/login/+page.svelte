...
<section class="">
    ...
    <div class="login-div max-w-md w-[calc(100vw-32px)] absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
        <div class=" bg-base-200/70 space-y-4 shadow-xl backdrop-blur-3xl p-8 rounded-2xl flex flex-col">
            ...
            <button class="btn btn-primary"><Icon icon='ri:google-fill' />เข้าสู่ระบบด้วย Google</button>
        </div>
    </div>
</section>
