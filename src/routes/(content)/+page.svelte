...
>
  ...
  >
    ...
    >
      ...
      <p>
        pcshs-short
        ทำให้การเข้าใช้งานเว็ปต่างๆเร็วขึ้นอย่างเห็นได้ชัดด้วยการทำให้คุณเข้าใช้งาน
        Link ที่สั้นลง
      </p>
    </div>
    <div
    ...
    >
      ...
      <p>
        psh-short ทำให้ Link นั้นสั้นกว่าเดิมไม่ว่า Link
        ที่คุณให้มานั้นจะยาวเพียงไหนก็ตาม
      </p>
    </div>
    <div
